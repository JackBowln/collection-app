...
CREATE TABLE "verificationtokens" (
    ...
    "token_type" "TokenType" NOT NULL DEFAULT 'API',
...
-- CreateIndex
CREATE UNIQUE INDEX "verificationtokens_id_identifier_token_key" ON "verificationtokens"("id", "identifier", "token");

-- AddForeignKey
ALTER TABLE "accounts" ADD CONSTRAINT "accounts_tokenId_fkey" FOREIGN KEY ("tokenId") REFERENCES "verificationtokens"("id") ON DELETE CASCADE ON UPDATE CASCADE;
